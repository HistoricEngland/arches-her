...
# root@2ff68380857c:/web_root/arches#  python manage.py test ../arches_her/arches_her/tests/bngpoint_to_geojson_fn_orig_tests_vs_refact.py  --pattern="*.py" --settings="tests.test_settings"
